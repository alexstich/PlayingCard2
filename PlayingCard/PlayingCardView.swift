...
class PlayingCardView: UIView {
    ...
    @IBInspectable var rank: Int = 7 { didSet { setNeedsDisplay(); setNeedsLayout() }}
    ...
    @objc func adjustFaceCardScale(byHandlingGestureRecognazedBy recognizer: UIPinchGestureRecognizer) {
    ...
    private lazy var upperLeftCornerLabel: UILabel = createCornerLabels()
    private lazy var lowerRightCornerLabel: UILabel = createCornerLabels()
    
    private func createCornerLabels() -> UILabel {
        let label = UILabel()
